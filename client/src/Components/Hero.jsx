    ...
    <section className=" text-gray-800 h-screen bg-[radial-gradient(#e5e7eb_1px,transparent_1px)] [background-size:16px_16px] ">
      <div className="container flex flex-col justify-center p-6 mx-auto sm:py-12 lg:py-24 lg:flex-row lg:justify-between">
        <div className="flex flex-col justify-center p-6 text-center rounded-sm lg:max-w-md xl:max-w-lg lg:text-left">
          <h1
			...
			ont-bold leadi sm:text-6xl"
          >
            EcoSustain
          </h1>
          <h2 className="text-4xl">
            <span className="text-green-600">Breathing</span> New Life into
            Tomorrow
          </h2>
          <p className="mt-6 mb-8 text-lg sm:mb-12">
            {" "}
            Join us in our mission to reduce environmental
          ...
          <div className="flex flex-col space-y-4 sm:items-center sm:justify-center sm:flex-row sm:space-y-0 sm:space-x-4 lg:justify-start">
            <Link
              ...
              to="/User/login"
              className="px-8 py-3 text-lg font-semibold rounded bg-green-600 text-gray-50"
            >
              Recycle
            </Link>
            <Link
      ...
      <div className="relative w-screen">
        <img
          src={feature}
          alt="kuch to hai"
          className="left-[100px] top-[-50px] -z-50 absolute"
        />
        <img
          src={feature}
          alt="ye kya hai"
          className="right-[50px] top-[-30px] rotate-90 -z-50 absolute"
        />
      </div>
    </section>
  );
